...
nnoremap ,sr :so ~/.vim/sessions/*.vim<BS><BS><BS><BS><BS>
nnoremap ,ss :mksession! ~/.vim/sessions/*.vim<BS><BS><BS><BS><BS>
...
set runtimepath+=~/.vim/bundle/endwise
...
set runtimepath+=~/.vim/bundle/vim-plugin-autosess
...
set runtimepath+=/usr/local/Cellar/macvim/8.2-169_2/MacVim.app/Contents/Resources/vim/vimfiles
set runtimepath+=/usr/local/Cellar/macvim/8.2-169_2/MacVim.app/Contents/Resources/vim/runtime
set runtimepath+=/usr/local/Cellar/macvim/8.2-169_2/MacVim.app/Contents/Resources/vim/runtime/pack/dist/opt/matchit
set runtimepath+=/usr/local/Cellar/macvim/8.2-169_2/MacVim.app/Contents/Resources/vim/vimfiles/after
...
tabnew
tabrewind
edit resources/src/scss/mex/_product.scss
...
let s:cpo_save=&cpo
set cpo&vim
cnoremap <buffer> <expr> <C-R><C-G> fugitive#buffer().rev()
...
normal! 05|
tabnext
edit resources/views/product.antlers.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
set winwidth=1
argglobal
balt resources/views/product.antlers.html
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <SNR>37_htmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
inoremap <buffer> <SNR>37_xhtmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
inoremap <buffer> <SNR>37_ragtagOopen <%= 
imap <buffer> <SNR>37_ragtagOclose  ><Left><Left>
cnoremap <buffer> <expr> <C-R><C-G> fugitive#buffer().rev()
...
imap <buffer> <C-X>- <  >2hi
imap <buffer> <C-X>] <script type="text/javascript"></script>O
inoremap <buffer> <C-X>> %>
inoremap <buffer> <C-X>< <%
imap <buffer> <SNR>39_ragtagOclose  ><Left><Left>
inoremap <buffer> <SNR>39_ragtagOopen <%= 
imap <buffer> <C-X><C-_> /
inoremap <buffer> <SNR>39_xhtmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
inoremap <buffer> <SNR>39_htmltrans <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
cnoremap <buffer> <expr>  fugitive#buffer().rev()
...
tabnext 1
set stal=1
badd +0 resources/src/scss/mex/_product.scss
badd +1 ./
badd +1 resources/views/product.antlers.html
badd +1 NERD_tree_1
